...
{	
	...
	private handlePeople(obj: any) : void {
		...
		// Building 1
		this.donutChartLabelsG1 = [ 'Erdgescho\u00df', 'Stockwert 1', 'Stockwert 2'];
		this.donutChartDataG1 = [ obj.building1.floor1, obj.building1.floor2, obj.building1.floor3];
		this.donutChartTypeG1 = 'doughnut';
		// Building 2
		this.donutChartLabelsG2 = [ 'Stockwerk 1', 'Stockwert 2', 'Stockwert 3', 'Stockwert 4', 'Stockwert 5'];
		...
		this.donutChartTypeG1 = 'doughnut';
		// Building 3
		this.donutChartLabelsG3 = [ 'Stockwerk 1', 'Stockwert 2', 'Stockwert 3'];
